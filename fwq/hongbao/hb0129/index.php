...
if( !isset($_GET['code']) ){
	echo '操作失败！';
	header('Location:https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx863e78b1aaf4d6f4&redirect_uri=http://tou.webg.top/yin/hongbao/hb0129/index.php&response_type=code&scope=snsapi_base&state=1#wechat_redirect');
	exit;
}
