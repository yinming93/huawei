<?php
  ...
  if(!$openid){
 	echo "<script>";
 	echo "window.location.href='http://ym.2dreamchaser.com/yin/2018/bm/bm/getcodeurl.php';";
 	echo "</script>";
 	exit;
 }
 // if ($row){
...
<script>
	...
	wx.config({
		...
		var shareinfo={
		 	 title: '龙湖冠寓钟园路店预约报名',
		      desc: '报名链接',
		      link: 'http://ym.2dreamchaser.com/yin/2018/bm/bm/getcodeurl.php',
		      imgUrl: 'http://ym.2dreamchaser.com/yin/2018/bm/bm/share.jpg'}
