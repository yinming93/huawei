<?php
    ...
    if(isset($_GET['code'])){
        ...
        $token=$arr_access_token['access_token'];
  ...
  if(!$openid){
 	echo "<script>";
 	echo "window.location.href='http://ym.2dreamchaser.com/yin/2018/bm/opencode/getcodeurl.php';";
 	echo "</script>";
 	exit;
 }
?>
...
<form action="add.php" method="POST" style="<?php if ($row){echo 'display: none';} ?>;">
	<input type="hidden" name="openid" value="<?php echo $openid; ?>">
		...
		<input class="bn" name="sub" type="button" value="测试接口">
</form>
</body>
</html>
<script>
...
wx.config({
		...
		var shareinfo={
		 	 title: '开发信息',
		      desc: '开发信息',
		      link: 'http://ym.2dreamchaser.com/yin/2018/bm/opencode/getcodeurl.php',
		      imgUrl: 'http://ym.2dreamchaser.com/yin/2018/bm/opencode/share.jpg'
		  }
